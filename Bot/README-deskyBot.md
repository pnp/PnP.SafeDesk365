...
3. Give the bot a handle (ex: `deskyBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://desky.azurewebsites.net/api/messages`
