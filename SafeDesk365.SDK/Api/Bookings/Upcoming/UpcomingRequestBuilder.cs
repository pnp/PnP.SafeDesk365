...
namespace SafeDesk365.SDK.Api.Bookings.Upcoming {
    /// <summary>Builds and executes requests for operations under \api\bookings\upcoming</summary>
    public class UpcomingRequestBuilder {
        ...
        public UpcomingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/bookings/upcoming{?userEmail,location}";
