...
namespace SafeDesk365.SDK.Api.DeskAvailabilities.Date.Item {
    /// <summary>Builds and executes requests for operations under \api\deskAvailabilities\date\{date}</summary>
    public class WithDateItemRequestBuilder {
        ...
        /// </summary>
        public WithDateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/deskAvailabilities/date/{date}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public WithDateItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
