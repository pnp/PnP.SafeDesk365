...
namespace SafeDesk365.SDK.Api.DeskAvailabilities.Location.Item {
    /// <summary>Builds and executes requests for operations under \api\deskAvailabilities\location\{location}</summary>
    public class WithLocationItemRequestBuilder {
        ...
        public WithLocationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/deskAvailabilities/location/{location}";
