...
/** Builds and executes requests for operations under /api/deskAvailabilities/location/{location}  */
export class WithLocationItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/deskAvailabilities/location/{location}";
