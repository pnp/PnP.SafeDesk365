...
/** Builds and executes requests for operations under /api/bookings/checkin/{id}  */
export class CheckinItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/bookings/checkin/{id}";
